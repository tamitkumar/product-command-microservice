...
import static com.tech.brain.utils.PollerConstants.HTTP_CODE_500;
import static com.tech.brain.utils.PollerConstants.HYPHEN;
...
public class PollerException extends RuntimeException {
    ...
    public PollerException(Exception exception) {
        super(exception);
    ...
    public PollerException(String code, String message) {
        super(message);
    ...
    public PollerException(String code, ErrorSeverity severity, String message) {
        super(message);
    ...
    public PollerException(String code, ErrorSeverity severity, String message, Exception exception) {
        super(exception);
        String builder = code + HYPHEN + severity + HYPHEN + message;
        this.code = code;
        this.message = builder;
