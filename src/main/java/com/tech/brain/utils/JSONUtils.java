...
public class JSONUtils {
    ...
    public String javaToJSON(Object object) {
        ...
        try {
            ...
            throw new CommandException(ErrorCode.ERR005.getErrorCode(), ErrorSeverity.ERROR,
    ...
    public <T> T jsonToJava(String json, Class<T> clazz) {
        ...
        try {
            ...
            throw new CommandException(ErrorCode.ERR006.getErrorCode(), ErrorSeverity.ERROR,
