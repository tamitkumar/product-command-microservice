...
import static com.tech.brain.utils.CommandConstants.HTTP_CODE_500;
import static com.tech.brain.utils.CommandConstants.HYPHEN;
...
public class CommandException extends RuntimeException {
    ...
    public CommandException(String code, ErrorSeverity severity, String message) {
        super(message);
    ...
    public CommandException(String code, ErrorSeverity severity, String message, Exception exception) {
        super(exception);
        String builder = code + HYPHEN + severity + HYPHEN + message;
        this.code = code;
        this.message = builder;
